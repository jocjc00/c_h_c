...
class IndexAdminInfoPage extends StatefulWidget {
  const IndexAdminInfoPage({Key? key}) : super(key: key);

  @override
  State<IndexAdminInfoPage> createState() => _IndexAdminInfoPageState();
}

class _IndexAdminInfoPageState extends State<IndexAdminInfoPage> {
    ...
    return SafeArea(
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          title: const Text('Index Admin Info Page'),
        ),
          ...
          children: [
            ...
            Padding(
              ...
              child: ElevatedButton(
                ...
                child: const Text('Add COVID19 Info'),
              ),
            ),
          ],
        ),
        body: Container(
          ...
          child: BlocProvider(
              ...
              child:
              BlocBuilder<AdminInfoBloc, AdminInfoState>(builder: (context, state) {
                if (state is AdminInitial) {
                  ...
                  return _UI(
                      context, state.adminInfoModel, onGoBack, refresh, adminInfoBloc);
                } else {
                  return const Center(child: CircularProgressIndicator());
                }
              })),
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      IconButton(
                                        ...
                                        onPressed: () {
                                          Navigator.push(
                                              context,
                                              MaterialPageRoute(
                                                  builder: (context) => const UpdateAdminInfoPage(),
                                      ...
                                      IconButton(
                                        ...
                                        onPressed: () {
                                          adminInfoBloc.add(DeleteAdminData(state[index].id));
                                          refresh();
                                        },
                                      ),
                                    ],
