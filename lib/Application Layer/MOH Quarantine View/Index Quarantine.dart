...
import '../User Quarantine View/viewQuarantineDetails.dart';

import 'addTestResult.dart';
import 'editTest.dart';

class IndexQuarantinePage extends StatefulWidget {
  const IndexQuarantinePage({Key? key}) : super(key: key);

  @override
  State<IndexQuarantinePage> createState() => _IndexQuarantinePageState();
}

class _IndexQuarantinePageState extends State<IndexQuarantinePage> {
              ...
              child: ElevatedButton(
                ...
                onPressed: () {
                  Navigator.push(
                    ...
                    MaterialPageRoute(
                        builder: (context) =>
                            const ViewQuarantineDetailsPage()),
                  ).then(onGoBack);
                },
