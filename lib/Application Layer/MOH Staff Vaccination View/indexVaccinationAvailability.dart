...
import 'addVaccinationAvailability.dart';
import 'updateVaccinationAvailability.dart';
    ...
    return SafeArea(
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          title: const Text('Index MOH Staff Availability Page'),
        ),
          ...
          child: BlocProvider(
              ...
              child:
                ...
                if (state is AdminInitial) {
                  ...
                  return _UI(context, state.adminVacModel, onGoBack, refresh,
                      adminBloc);
                } else {
                  return const Center(child: CircularProgressIndicator());
                }
